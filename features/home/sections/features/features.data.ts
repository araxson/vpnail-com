export const featuresData = {
  ...
  features: [
    { icon: 'Sparkles', title: 'Creative Artistry', description: 'As Calgary\'s go-to studio for custom nail design in Victoria Park, our talented technicians bring your vision to life.' },
    ...
    { icon: 'Heart', title: 'An Oasis of Relaxation', description: 'Our Victoria Park salon is designed to be your escape from the Calgary hustle. From the moment you arrive at our 1411 1st Street SE location, our friendly team is dedicated to your comfort and relaxation.' },
  ],
} as const
